...
- [czkawka #Project#](https://github.com/qarmin/czkawka): Multi functional app to find duplicates, empty folders etc.

- [zenith #Project#](https://github.com/bvaisvil/zenith): In terminal graphical metrics for your `*nix` system written in Rust
